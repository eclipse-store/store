...
public class PrimitiveArrayTypes implements BinaryHandlerTestData {
    ...
    public void proveResults(Object o) {
        ...
        assertAll("Primitive Types tests", //
                ...
                () -> assertArrayEquals(this.getIntValues(), copy.getIntValues(), "int[]"),
                ...
                () -> assertArrayEquals(this.getCharValues(), copy.getCharValues(), "char[]"),
                ...
                () -> assertArrayEquals(this.getIntValueMatrix(), copy.getIntValueMatrix(), "int[][]"),
                ...
                () -> assertArrayEquals(this.getCharValueMatrix(), copy.getCharValueMatrix(), "char[][]")
        );
    }
