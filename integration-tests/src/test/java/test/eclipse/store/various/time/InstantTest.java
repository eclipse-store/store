...
public class InstantTest
{
    ...
    void instantStoreAndReload()
    {
        ...
        // installed rather than set: where Instant is a value class it cannot be an explicit root
        try (EmbeddedStorageManager storageManager = RootStorages.startWithRoot(tempDir, i)) {
    ...
    void instantUpdateApiBehavior()
    {
        ...
        if (XReflect.isValueClass(Instant.class)) {
            ...
            assertThrows(PersistenceException.class, () -> EmbeddedStorage.start(i2, tempDir).shutdown(),
