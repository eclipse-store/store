...
public class BooleanLegacy2 {
    ...
    public byte getTo_byte() {
        return to_byte;
    }

    public void setTo_byte(byte to_byte) {
    ...
    public char getTo_char() {
        return to_char;
    }

    public void setTo_char(char to_char) {
