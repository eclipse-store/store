...
Child objects encountered during graph traversal use xref:storing-data/lazy-eager-full.adoc[lazy semantics] and are only stored if they are not yet known to the persistence context.
