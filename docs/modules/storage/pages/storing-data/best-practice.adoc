...
The default storer will call the `collect` method for each object registered to be stored during the storers store phase. Implementers should be aware that this has an impact on the storer performance.
