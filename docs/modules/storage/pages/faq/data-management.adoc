...
Instead, new data is appended and the old data becomes "garbage."
...
* Consider using the xref:addendum/tools.adoc#_storage_converter[Storage Converter] to compact storage if needed
