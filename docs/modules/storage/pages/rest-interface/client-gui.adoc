...
----
mvn dependency:get -Dartifact=org.eclipse.store:storage-restclient-app-standalone:{maven-version}:jar -Dtransitive=false -Ddest=storage.restclient.app-{maven-version}.jar
----
