...
To get started with the wrapper code generator:

* xref:wrapping/configuration.adoc[Configuration] — how to set up the annotation processor and specify the types to generate wrappers for
* xref:wrapping/usage.adoc[Usage] — how to use the generated wrapper types in your application
