...
<dependencies>
   <dependency>
      ...
      <artifactId>integrations-cdi4</artifactId>
...
The configuration of the _StorageManager_ can be done using key/value pairs that are provided by MicroProfile Config.  The configuration keys must be prefixed by `org.eclipse.store`
