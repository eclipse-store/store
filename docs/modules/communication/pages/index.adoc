...
Eclipse Serializer provides a module for simple object based network communication over TCP connections.
...
The Object communication of Eclipse Serializer is available in two flavors:
