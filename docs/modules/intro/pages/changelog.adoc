...
* xref:gigamap:indexing/jvector/index.adoc[Vector index for GigaMap] https://github.com/eclipse-store/store/pull/548[[548]]
* Lucene index update https://github.com/eclipse-store/store/pull/546[[546]]
...
* Fix for ArrayIndexOutOfBoundsException in GigaMap https://github.com/eclipse-store/store/issues/500[[500]] https://github.com/eclipse-store/store/pull/524[[524]]
* Fix for NullPointerException in GigaMap https://github.com/eclipse-store/store/pull/549[[549]]
