...
----
Java Object ──> Serializer ──> Binary Data ──> Storage Channel ──> Storage Target
                                                                   (File System,
                                                                    S3, SQL, etc.)
----

1. *Object graph traversal* — the storage manager traverses the object graph starting from the stored object, identifying all referenced objects that need to be persisted
