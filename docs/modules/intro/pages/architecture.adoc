...
Classes do not need to implement `java.io.Serializable`, carry annotations, or provide a default constructor; only types tied to JVM internals (e.g. `Thread`, IO streams) are excluded.
