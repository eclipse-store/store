...
public class IntegerNonPrimitiveIndexTest
{
    @TempDir
    Path tempDir;
    ...
    void nullTests()
    {
        ...
        assertEquals(0, map.query(integerPersonIndex.lessThan(null)).count());
        assertEquals(0, map.query(integerPersonIndex.lessThanEqual(null)).count());
        assertEquals(0, map.query(integerPersonIndex.greaterThan(null)).count());
        assertEquals(0, map.query(integerPersonIndex.greaterThanEqual(null)).count());

        assertEquals(0, map.query(integerPersonIndex.between(null, null)).count());
        assertEquals(0, map.query(integerPersonIndex.between(30, null)).count());
        assertEquals(0, map.query(integerPersonIndex.between(null, 30)).count());
    }
    ...
    void notNull()
    {
        ...
        try (EmbeddedStorageManager manager = EmbeddedStorage.start(tempDir)) {
            ...
            newMap.add(new IntegerPerson("Karl", null));
            newMap.store();
            long count1 = newMap.query(integerPersonIndex.notNull()).count();
            assertEquals(11, count1);
        }
    }
    ...
    void isNull()
    {
        ...
        try (EmbeddedStorageManager manager = EmbeddedStorage.start(tempDir)) {
            ...
            newMap.add(new IntegerPerson("Karl", null));
            newMap.store();
            long count1 = newMap.query(integerPersonIndex.isNull()).count();
    ...
    private static class IntegerPerson
    {
        ...
        public IntegerPerson(String name, Integer age)
        {
            this.name = name;
            this.age = age;
        }
