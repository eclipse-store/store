 ...
 * @see IndexerInstant
 */
public interface IndexerZonedDateTime<E> extends IndexerDateTime<E, Object[], ZonedDateTime>
{
	 ...
	 * @param <E> the entity type
	 */
	public abstract class Abstract<E> extends HashingCompositeIndexer.AbstractSingleValueFixedSize<E, ZonedDateTime> implements IndexerZonedDateTime<E>
	{
		...
		@Override
		public final <S extends E> Condition<S> is(final ZonedDateTime other)
		{
			return other == null
				? this.isNull()
				: this.isValue(other)
		...
		@SuppressWarnings("unchecked")
		@Override
		public final <S extends E> Condition<S> before(final ZonedDateTime boundExclusive)
		{
		...
		@SuppressWarnings("unchecked")
		@Override
		public final <S extends E> Condition<S> beforeEqual(final ZonedDateTime boundInclusive)
		{
		...
		@SuppressWarnings("unchecked")
		@Override
		public final <S extends E> Condition<S> after(final ZonedDateTime boundExclusive)
		{
			if(boundExclusive == null)
			{
				throw new IllegalArgumentException("boundExclusive cannot be null");
		...
		@SuppressWarnings("unchecked")
		@Override
		public final <S extends E> Condition<S> afterEqual(final ZonedDateTime boundInclusive)
		{
			if(boundInclusive == null)
			{
				throw new IllegalArgumentException("boundInclusive cannot be null");
		...
		@SuppressWarnings("unchecked")
		@Override
		public final <S extends E> Condition<S> between(final ZonedDateTime startInclusive, final ZonedDateTime endInclusive)
		{
