...
```console
java -jar storage-embedded-tools-storage-converter-4.0.0-SNAPSHOT-standalone.jar sourceConfig.ini targetConfig.ini
```
...
```console
java -jar storage-embedded-tools-storage-converter-4.0.0-SNAPSHOT-standalone.jar src.ini dst.ini -c org.eclipse.store.storage.embedded.tools.storage.converter.BinaryConverterBitmapLevel2
```
