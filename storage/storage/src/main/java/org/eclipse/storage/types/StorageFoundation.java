...
import org.eclipse.storage.base.util.ProcessIdentityProvider;
import org.eclipse.storage.persistence.types.BinaryEntityRawDataIterator;
import org.eclipse.storage.persistence.types.ObjectIdsSelector;
...
public interface StorageFoundation<F extends StorageFoundation<?>> extends InstanceDispatcher
{
	...
	implements StorageFoundation<F>, Unpersistable
	{
		...
		@Override
		public F setWriterProvider(final StorageFileWriter.Provider writerProvider)
		{
		...
		{
			/* (11.02.2019 TM)NOTE: On byte order switching:
			 * Theoretically, the storage engine (OGS) could use the switchByteOrder mechanism implemented for
			 * communication (OGC). However, there are a lot stumbling blocks involved in the details that
