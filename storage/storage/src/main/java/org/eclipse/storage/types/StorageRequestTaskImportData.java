...
import org.eclipse.storage.exceptions.StorageExceptionImportFailed;
import org.eclipse.storage.types.StorageDataFileItemIterator.ItemProcessor;
import org.eclipse.storage.afs.base.AFSUtils;
import org.eclipse.storage.base.collections.ArraysUtils;
import org.eclipse.storage.base.concurrency.ThreadsUtils;
...
public interface StorageRequestTaskImportData extends StorageRequestTask
{
	...
	implements StorageRequestTaskImportData, StorageChannelTaskStoreEntities
	{
		...
		private synchronized void ensureReaderThread()
		{
			...
			this.readThread = ThreadsUtils.start(this::readFiles);
		}
...
//				DEBUGStorage.println("Reader reading source file " + file);
				try
				{
					...
					AFSUtils.execute(file, rf -> iterator.iterateStoredItems(rf));
