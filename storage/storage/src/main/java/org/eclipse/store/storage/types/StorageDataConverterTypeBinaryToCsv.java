...
public interface StorageDataConverterTypeBinaryToCsv
{
	...
	StorageDataFileItemIterator.ItemProcessor
	{
		...
		)
		{
			...
			this.literalDelimiter        = MemoryCharConversionUTF8.toSingleByte(csvConfig.literalDelimiter())         ;
			this.valueSeparator          = MemoryCharConversionUTF8.toSingleByte(csvConfig.valueSeparator()  )         ;
			this.lineSeparator         = MemoryCharConversionUTF8.toSingleByte(csvConfig.lineSeparator() )         ;
			this.escaper                 = MemoryCharConversionUTF8.toSingleByte(csvConfig.escaper()         )         ;
			...
			this.listStarter             = MemoryCharConversionUTF8.toSingleByte(configuration.literalListStarter()   );
			this.listTerminator          = MemoryCharConversionUTF8.toSingleByte(configuration.literalListTerminator());
			this.listSeparator           = MemoryCharConversionUTF8.toSingleByte(configuration.literalListSeparator() );
	 ...
	 * Something like:
---------------------
"channel1_1@1234:org.eclipse.serializer.collections.BulkList"
{
