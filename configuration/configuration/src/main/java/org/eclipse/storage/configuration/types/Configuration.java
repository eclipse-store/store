package org.eclipse.storage.configuration.types;
...
import org.eclipse.storage.configuration.exceptions.ConfigurationExceptionNoValueMapperFound;
import org.eclipse.storage.configuration.exceptions.ConfigurationExceptionValueMappingFailed;
 ...
 * <pre>
 * String directory = configuration.child("eclipse").child("storage").get("storageDirectory");
 * </pre>
 * or just use the full-qualified key, as a shortcut
 * <pre>
 * String directory = configuration.get("eclipse.storage.storageDirectory");
 * </pre>
 ...
 * 	.build();
 * 
 * boolean production = configuration.getBoolean("eclipse.storage.production");
